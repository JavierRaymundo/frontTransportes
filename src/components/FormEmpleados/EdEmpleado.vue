<template>
  <div class="empleado container w-50 card p-5 d-flex mt-5">
    <h2 class="text-center mb-5">Editar Empleado</h2>
      <div class="input-group mb-3">
      <span class="input-group-text py-2" id="basic-addon1">Nombres:</span>
      <input type="text" class="form-control" placeholder="Nombres" v-model.trim="empleado.nombres" >
    </div>
...
<div class="input-group mb-3">
      <span class="input-group-text py-2" id="basic-addon1">Telefono:</span>
      <input type="text" class="form-control" placeholder="Telefono" v-model.trim="empleado.telefono">
    </div>
